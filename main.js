...
warBackRedEl = document.getElementById("warBackRed");
warBackBlueEl = document.getElementById("warBackBlue");
...
function shuffle() {
    ...
    warBackBlueEl.className = "";
    warBackRedEl.className = "";
...
function war(playerCards, cpuCards){
    ...
    warBackBlueEl.className = "card small back-blue";
    warBackRedEl.className = "card small back-red";
